...
public class TurnaroundCalculator {
    public static void main(String[] args) throws IOException {
        int counter = 1;
        while (counter <= 5) {
            String path = "C://Users/talle/Desktop/OS Study/Scheduleres/input1.txt";
            ...
            switch (counter) {
                ...
                case 2 -> {
                    double LCFSNonPreemptive = calculateLCFSNonPreemptive(processList);
        ...
        while (completed < numProcesses) {
            ...
            readyQueue.sort(new Comparator<Process>() {
                ...
                public int compare(Process o1, Process o2) {
                    if(Integer.compare(o1.arrivalTime,o2.arrivalTime) != 0)
                        return Integer.compare(o1.arrivalTime,o2.arrivalTime)*(-1);
                    return Integer.compare(o1.getIndex(),o2.getIndex())*(-1);
                }
            });
    ...
    public static double calculateSJFPreemptive(List<Process> processList) {
        ...
        while (completed < n) {
            ...
            // Sort ready queue in ascending order of running time
            readyQueue.sort((a, b) -> a.getLength() - b.getLength());
            // Get next process from ready queue
            Process p = readyQueue.get(0);
            currentTime++;
            p.setRemaining(p.getRemaining()-1);
